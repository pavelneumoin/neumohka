...
<div class="bubble"><img class="bip-head" src="../../assets/bip-head.svg"><span>Когда n стало 0, условие n &gt; 0 — ложь. Я перестаю повторять и выхожу из цикла.</span></div>
...
<div class="tip">Главное правило: счётчик должен двигаться к тому, чтобы условие стало ложным. Иначе цикл не остановится.</div>
...
<div class="try">Набери программу целиком — и проверь, что в самом конце печатается <strong>ПУСК!</strong></div>
